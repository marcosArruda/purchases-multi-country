...
func Test_serviceManagerFinal_WithExchangeService(t *testing.T) {
	type args struct {
		p ExchangeService
	}
	sm := NewManager(nil, nil)
	s := NewNoOpsExchangeService()
	tests := []struct {
		name string
		m    *serviceManagerFinal
		args args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.m.WithExchangeService(tt.args.p); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("serviceManagerFinal.WithExchangeService() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_serviceManagerFinal_ExchangeService(t *testing.T) {
	sm := NewManager(nil, nil)
	s := NewNoOpsExchangeService()
	sm.WithExchangeService(s)
	tests := []struct {
		name string
		m    *serviceManagerFinal
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.m.ExchangeService(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("serviceManagerFinal.ExchangeService() = %v, want %v", got, tt.want)
			}
		})
	}
}
